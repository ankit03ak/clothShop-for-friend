...
const Login = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 px-2 pt-16 pb-[83px] justify-center flex">
  ...
  <div className="bg-white/95 backdrop-blur-xl rounded shadow-2xl p-8 max-w-md w-full border border-white/20">
    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      >
        ...
        <span className="relative z-10 flex items-center justify-center">
          {loading ? (<><div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white mr-3"></div> Signing In...</>) : (<> Sing In </>)}
    ...
    <div className="text-center mt-8">
      <p className="text-gray-600">
        ...
        <a href="/signup" className="ml-1 text-purple-600 hover:text-purple-700 font-semibold hover:underline transition-colors">
          Sign up here
        </a>
      </p>
    </div>
